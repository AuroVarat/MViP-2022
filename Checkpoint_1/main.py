...
index_matrix = np.random.randint(0,N, size=(pnum*nstep,4)) #initialise random values
...
#update loop here - for Glauber dynamics
    ...
    file_object.write('\n{} {} {} {} {} {} {} {} {}'.format(kT, mean_data[0],av_M, C_v/(kT**2), err_C_v,X/kT,err_X))
